...
Considers three possible outcomes for modifier partitioning:
    ...
    NBO conversion on trigonal B, N3 -> N2
...
from hypergeometric import get_data, get_col, N4_N2_Q3_expectation, chi_sq
...
f = lambda x, H_Si, H_B2: N4_N2_Q3_expectation(
...
print ("Wallenius fit yields H_Si={} and H_B2={} "
       "with ssq={}").format(fit[0], fit[1], chi_sq(N4, fitN4))
